...
public interface IBlogPostRepo extends Repository<EIBlogPost, Long> {
    ...
    @Query(value = "select a, b from EIBlogPost a, EIScreenshot b where a.BlogPostId = b.BlogPostId and a.BlogPostDisabled = 0 and b.ScreenshotDisabled = 0 order by b.ScreenshotId asc", types = {EIBlogPost.class, EIScreenshot.class})
    List<EIBlogPostAndScreenshot> queryAll();

    @Query(value = "select a, b from EIBlogPost a, EIScreenshot b where a.BlogPostId = b.BlogPostId and a.BlogCategoryId = $0 and a.BlogPostDisabled = 0 and b.ScreenshotDisabled = 0 order by b.ScreenshotId asc", types = {EIBlogPost.class, EIScreenshot.class})
