...
public class ListPhotoesCtrl extends WithMatcher {
    ...
    @Override
    public String name() {
        return "list all photos of a page";
    }

    @Override
    public String urlPattern() {
        return "/diary/list/photo/:pageId";
    }
    ...
    public void handle(HttpRequest httpRequest, HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        try {
            ...
            RestHelper.oneCallAndRet(httpResponse, diaryService, "listPhotos", pageId);
        } catch (Exception e) {
