...
public class SavePhotoCtrl extends WithMatcher {
    ...
    public String urlPattern() {
        return "/diary/save/photo";
    }

    @Override
    public void handle(HttpRequest httpRequest, HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        EIDiaryPhoto eiDiaryPhoto = RestHelper.getBodyAsObject(httpRequest, EIDiaryPhoto.class);
        RestHelper.oneCallAndRet(httpResponse, diaryService, "savePhoto", eiDiaryPhoto);
    }
}
