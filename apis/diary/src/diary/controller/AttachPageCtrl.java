...
public class AttachPageCtrl extends WithMatcher {
    ...
    @Override
    public String name() {
        return "attach a page to a book";
    }

    @Override
    public String urlPattern() {
        return "/diary/attach/:bookId/:pageId";
    }
    ...
    public void handle(HttpRequest httpRequest, HttpResponse httpResponse, HttpContext httpContext) throws HttpException, IOException {
        ...
        try {
            ...
            RestHelper.oneCallAndRet(httpResponse, diaryService, "attachPage", bookId, pageId);
        } catch (Exception e) {
